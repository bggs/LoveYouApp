...
import com.liujie.loveyouapp.mvp.service.OnResponseListener;
...
public class WXShare {
    public static final String APP_ID = "wxcce8c94bb2981211";
    ...
    public WXShare shareUrl(int flag, Context context, String url, String title, String descroption) {
        ...
        Bitmap thumb = BitmapFactory.decodeResource(context.getResources(), R.mipmap.add_card);
